        ...
        <form method="POST" action="/atualizar/{{$contato ->id}}">
           ...
           <div class="form-group mb-2">
                <label for="formGroupExampleInput2" >Telefone</label>
                    <input type="text" class="form-control" name="telefone" value= "{{$contato->telefone}}" placeholder="(XX)XXXXX-XXXX" >
           </div>
           <div class="form-group mb-2">
                <label for="formGroupExampleInput2" >Origem</label>
                <select id="inputState" class="form-select" name="origem" value= "{{$contato->origem}}">
           ...
           <div class="form-group mb-2">
                <label for="formGroupExampleInput2">Data do Contato</label>
                    <input type="text" class="form-control" name="datacontato" value= "{{$contato->datacontato}}" placeholder="XXXX/XX/XX">
           </div>
           <div class="form-group mb-2">
                <label for="exampleFormControlTextarea1">Observação</label>
                     <textarea class="form-control" rows="3" name="observacao" value= "{{$contato->observacao}}"></textarea>
           </div>
